...
(check-equal?
 (world-in-rally (make-world (make-ball 330 647 3 9) (make-racket 330 384 0 0) WHITE 0 0.05 false true))
                   (make-world (make-ball 330 647 0 0) (make-racket 330 384 0 0) YELLOW 1 0.05 false false))
